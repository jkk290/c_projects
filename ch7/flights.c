/* Takes a given time in 12-hours format, and displays the departure and arrival for the flight whose 
...
int main(void)
{
	...
	printf("Enter a 12-hour time(HH:MM A/AM/P/PM): ");
